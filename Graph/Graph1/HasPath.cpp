...
class Graph{
        ...
        public:
            ...
            bool pathHelper(int src, int dest, vector<bool>&vis){
                ...
                return false; // jab koi node ke saare neigbour bhi visited ho aur uski value source se na match kare.. then it'll return false.
            }
...
// 0 1 3 4 2 5 6 
    ...
    cout <<" has path 0->5 (true->1/false->0) " << graph.hasPath(0,5); //1
    return 0;
}